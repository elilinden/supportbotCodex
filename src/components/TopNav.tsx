...
export function TopNav() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-ui-border bg-ui-surface/80 backdrop-blur-md">
      <div className="w-full px-4 py-4 sm:px-6 lg:px-10">
        <div className="flex w-full flex-wrap items-center justify-between gap-4">
          <div className="min-w-[220px]">
            ...
            <p className="text-xs text-ui-textMuted">Orders of Protection / Information-only</p>
          </div>
